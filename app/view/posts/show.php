...
<div class="container">
  ...
  <div class="mb-5 mx-5 mt-2">
    ...
    <div class="px-2 mb-3 font-italic">By <?php echo $data['user']->userName; ?> on <?php echo $data['post']->created; ?>
    </div>
    <p class="card-text px-2 mb-3"><?php echo $data['post']->body; ?></p>
    <?php if($data['post']->userID == $_SESSION['user_id']) : ?>
    <div class="row">
    <div class="col-md-6">
      <a href="<?php echo URLROOT; ?>/posts/edit/<?php echo $data['post']->id; ?>" class="btn btn-primary mb-3 w-100">Edit</a>
    </div>
    <div class="col-md-6">
    ...
    <?php endif; ?>
    <div class="col">
      <a href="<?php echo URLROOT; ?>/posts" class="btn btn-warning w-100"><i class="fa fa-backward"></i> Back to Forum</a>
